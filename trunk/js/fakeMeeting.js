  ...
  function showItinerary(json) {     
	 ...
	 var unit=  "<div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapse\""+json[i]+"\">"+json[i]+"</a></h4></div>"+"<div id=\"collapse\""+json[i]+"\"class=\"panel-collapse collapse\"><div class=\"panel-body\">";
	var meeting=""
 	var element=""
        for (var j=0;j< roadTripCity.length; j++){
        	...
        	for (var k=0;k< roadTripfriendmeetChicago.length-1; k++){
        	 ...
        	 friends+=roadTripfriendmeetChicago[roadTripfriendmeetChicago.length-1]
               	meeting+=friends+"</dd><dt >Date</dt><dd id=\"date\">"+roadTripMeetingChincagoDATE+"</dd><dt>Time</dt><dd>"+roadTripMeetingChincagoTIME+"</dd><dt>Location</dt><dd>"+roadTripMeetingChincagolocation+"</dd></dl><hr>"
